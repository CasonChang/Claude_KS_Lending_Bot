...
- **FRR 天期配對（2026-08-20 確認）**：Bitfinex 官方說明指出 funding order 會配對相同 rate 與 period 的 bid；
  FRR 只代表浮動利率，並不忽略天期。子帳戶 08-18 改掛 7 天 FRR 後開始長時間未成交，後續檢討要分開統計
  7／30／120 天的等待與成交率，不可把「市場觸及 FRR」直接等同所有天期都能成交。
