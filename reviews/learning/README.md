...
- **FRR 第三階段（2026-08-20 起）**：主帳戶 USD／USDT 都改掛 120 天 FRR；曝險由動態 15% 改為每幣別
  固定 1,000 元硬上限（掛單中＋放貸中合計），避免入金／提幣後又自動增加可能鎖 120 天的金額。
  Zeabur `FRR_MAX_AMOUNT` 可永久覆寫；Telegram `/frrcap 金額` 可暫時調整至下次重啟。
